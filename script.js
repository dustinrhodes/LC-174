...
$(document).ready(function() {
  $.simpleWeather({
    ...
    success: function(weather) {
      html =  '<div class="today"><p>'+weather.city+', '+weather.region+' - '+weather.updated+'</p>';
      ...
      html += '<div class="data"><p>Wind Chill: '+weather.wind.chill+'&deg;'+weather.units.temp+'</p>';
      html += '<p>Heat Index: '+weather.heatindex+'&deg;'+weather.units.temp+'</p>';
      html += '<p>Wind: '+weather.wind.speed+ ' mph ' +weather.wind.direction+'</p>';
      html += '<p>Humidity: '+weather.humidity+'%</p>';
      html += '<p>Barometric Pressure: '+weather.pressure+' in</p></div>';

      html += '<div class="forecast"><p>'+weather.forecast[1].day+', '+weather.forecast[1].date+'</p>';
      ...
      html += '<div class="forecast"><p>'+weather.forecast[2].day+', '+weather.forecast[2].date+'</p>';
